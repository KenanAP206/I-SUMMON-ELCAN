...
export default function AdminEditRoom({ roomId = "103" }) {
  ...
  // Simulate loading existing room data
  useEffect(() => {
    const loadRoomData = () => {
      // Simulate API call
      setTimeout(() => {
    ...
    <div className="p-6 bg-slate-800 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-2xl font-semibold text-white">Edit Room {formData.roomNumber}</h1>
        </div>
